  ...
  return (
    <>
        ...
        {settlements.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full mt-4 py-2.5 sm:py-3 bg-slate-900 hover:bg-black text-white text-xs sm:text-sm font-semibold rounded-xl flex items-center justify-center gap-1.5 transition active:scale-[0.98] cursor-pointer"
            >
      ...
      <ConfirmModal
        ...
        variant="success"
        title="Hesapları Kapat?"
        message="Tüm para transferlerinin yapıldığını onaylıyor musunuz? Masraf geçmişi sıfırlanacak ve hesap kapatılacaktır."
